...
BOT_USERNAME = environ.get("BOT_USERNAME", "AcheronXRoBot")
BOT_NAME = environ.get("BOT_NAME", "Acheron")
BOT_ID = environ.get("BOT_ID", "7527380082")
S_GROUP = environ.get('S_GROUP', "ANTIKPOPSQUAD0000")
S_CHANNEL = environ.get('S_CHANNEL', "Stelleron_Hunter")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/ANTIKPOPSQUAD0000')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Stelleron_Hunter')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Stelleron_Hunter')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴘᴏᴡᴇʀᴇᴅ ʙʏ Nexus💞•𓆪」')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002354675474'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'ANTIKPOPSQUAD0000')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002011117693')).split()]
